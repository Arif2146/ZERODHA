...
lakh crores worth of equity investments.</p>
                    <h2 className="fs-4">Simplicity at its best</h2>
...
your needs.</p>
                    <h2 className="fs-4">Helping you do better</h2>
                    <p className='text-muted'>With initiatives like Nudge and Kill Switch, we don't just
facilitate transactions, but actively help you do better with
your money.</p>
                </div>
                <div className="col-6 p-5">
                    <img src={ecosystemImage} alt="ecosystem" style={{width:"90%"}}/>
                    <div className="text-center ">
                        <a href=' ' className="mx-5" style={{textDecoration:"none"}}>Explore our products <i className="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
                        <a href=' ' style={{textDecoration:"none"}}>Try Kite<i className="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
