      ...
      <div className="container mt-5">
        <div className="row">
          ...
          <div className="col-6 p-5 mt-5">
            ...
            <p className="mb-5">We are the largest stock broker in india.there are many variations of passages of Lorem Ipsum available</p>
          <div className="row">
            <div className="col-6">
              <ul>
                <li><p>Future and Options</p></li>
                <li><p>comidity Derivatives</p></li>
